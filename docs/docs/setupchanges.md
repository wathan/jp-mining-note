...
!!! Warning
    ...
    use, the AJTWordPitch should only contain autogenerated content, so this
...
## Reformat any entries in the PAOverrideText field { #v0-12-0-0-prerelease-13-reformat-paoverride }
